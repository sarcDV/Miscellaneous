...
from torchio.transforms.augmentation import intensity
...
from utilities_new import MoCoDatasetTorchIO, tensorboard_correction, getSSIM
...
log_path = './TBLogs'
trainID = 'RN56-ALL-BS1-TIO-Ptch10-noBNorm-rndOrient'
#'RN28-ALL-BS1-m1d0-M2d0-Ptch10-noBNorm'
#'RN14-ALL-BS1-m1d0-M2d0-Ptch10-noBNorm'
#'RN14-ALL-BS1-m1d5-M2d5-Ptch10-noBNorm'
save_path = './Results'
...
trainset = MoCoDatasetTorchIO(traindata, patches=patches, 
                       size=size_,
...
valset = MoCoDatasetTorchIO(valdata, patches=patches, 
                       size=size_,
                       orientation=orientation,
                       level_noise = level_noise,
                       num_ghosts=num_ghosts,
